public class Ejercicio_4 {
    public static void main(String[] args) {
        ...
        int hora = MiEntradaSalida.leerEnteroDeRango("Introdcuce tu hora: ", 0,23);
        int minutos = MiEntradaSalida.leerEnteroDeRango("Introdcuce tus minutos: ", 0,59);
        int segundos = MiEntradaSalida.leerEnteroDeRango("Introdcuce tus segundos: ", 0,59);
