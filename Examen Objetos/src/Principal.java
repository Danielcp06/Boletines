...
public class Principal {
    ...
    private static void probarNave(Nave nave) {
        try {
            ...
            System.out.printf("La nave %s ha saltado al hiperespacio correctamente.%n", nave.getNombreNave());
        } catch (NaveException e) {
            System.out.printf("La nave %s no puede saltar al hiperespacio: %s%n", nave.getNombreNave(), e.getMessage());
        }
    }
}